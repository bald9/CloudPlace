 ...
 * @since 1.6
 */
public final class HttpCookie_useless implements Cloneable, Serializable {
    // ---------------- Fields --------------
     ...
     * @see #setVersion
     */
    public HttpCookie_useless(String name, String value) {
        this(name, value, null /*header*/);
    }

    private HttpCookie_useless(String name, String value, String header) {
        name = name.trim();
     ...
     */
    public static List<HttpCookie_useless> parse(String header) {
    ...
    // class.
    private static List<HttpCookie_useless> parse(String header, boolean retainHeader) {
        ...
        List<HttpCookie_useless> cookies = new java.util.ArrayList<>();
        ...
        if (version == 0) {
            ...
            HttpCookie_useless cookie = parseInternal(header, retainHeader);
            cookie.setVersion(0);
            cookies.add(cookie);
        } else {
            // rfc2965/2109 cookie
            ...
            for (String cookieStr : cookieStrings) {
                HttpCookie_useless cookie = parseInternal(cookieStr, retainHeader);
                cookie.setVersion(1);
                cookies.add(cookie);
            }
        }
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (!(obj instanceof HttpCookie_useless))
            return false;
        HttpCookie_useless other = (HttpCookie_useless)obj;
     ...
     */
    private static HttpCookie_useless parseInternal(String header,
                                                    boolean retainHeader)
    {
        HttpCookie_useless cookie = null;
        ...
        try {
            ...
            if (index != -1) {
                ...
                if (retainHeader)
                    cookie = new HttpCookie_useless(name,
    ...
    static interface CookieAttributeAssignor {
            public void assign(HttpCookie_useless cookie,
                               String attrName,
                               String attrValue);
    }
    ...
    private static void assignAttribute(HttpCookie_useless cookie,
                                        String attrName,
                                        String attrValue)
    {
...
//                    return (List<java.net.HttpCookie>)HttpCookie.parse(header, true);
//                }
//
//                public String header(java.net.HttpCookie cookie) {
//                    return ((HttpCookie)cookie).header;
//                }
//            }
//        );
//    }
